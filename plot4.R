...
par(mfrow = c(2, 2))
with(base, {
        plot(base$Date1, base$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
        plot(base$Date1, base$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
        ...
        plot(base$Date1, base$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
